...
function tscExecutor(_options, context) {
    return (0, tslib_1.__asyncGenerator)(this, arguments, function* tscExecutor_1() {
        ...
        if (options.watch) {
            ...
            const disposePackageJsonChanged = yield (0, tslib_1.__await)((0, watch_for_single_file_changes_1.watchForSingleFileChanges)((0, path_1.join)(context.root, projectRoot), 'package.json', () => (0, update_package_json_1.updatePackageJson)(options, context, target, dependencies)));
